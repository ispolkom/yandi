...
TRICKY = [
    ...
    "_", "-", "'", "’", "«", "»", "—", "…", ".", ",", "!", "?", ":", ";", "(", ")", "[", "]", "{", "}", "\"", "\\", "/", "#", "%", "$", "@", "&", "*",
    "\t", "\n", "\r", " ", "  ",
    # символы НОВЕЕ Unicode 14 (Python 3.11 их не знает, Rust std/крейты — знают): регистр и композиции расходились до py_lower/py_casefold/py_nfc
    "\ua7cb", "\ua7cc", "\ua7d2", "\ua7d4", "\u1c89", "\U000113c2", "\U000113b8", "\U0001611e", "\U00016d67",
]
