...
```
$ /home/user/venv/bin/python3 -m agent.claim_lifecycle_regression_test
...
...
`py_compile` чист на всех изменённых/новых файлах (через `/home/user/venv/bin/python3`,
...
```
/home/user/venv/bin/python3 agent/orchestrator_v2.py "Есть ли разумная жизнь на Юпитере?" --web --no-cache 2>&1 | tee /tmp/yandi_claim_lifecycle_fix_live.log
```
