...
================================================================================
Дата: 2026-08-27
Скоуп: /home/user/yandi/agent/ ТОЛЬКО (не yandi целиком — pet/, node/, registry/
...
- **Regression sweep: 29/29 GREEN.** Все `agent/*_regression_test.py`
  (найдено 29 файлов) пройдены через `/home/user/venv/bin/python3` с
  `PYTHONPATH=/home/user/yandi` (venv существует по пути `/home/user/venv`,
