...
fail=0; n=0
for f in $(ls agent/*_rust_parity_test.py pet/*_rust_parity_test.py 2>/dev/null) agent/rust_unicode_fuzz_parity_test.py agent/rust_python_text_semantics_parity_test.py llm_gateway/native_parity_test.py llm_gateway/native_remote_parity_test.py llm_gateway/native_secure_store_parity_test.py llm_gateway/native_client_parity_test.py llm_gateway/native_intelligence_parity_test.py llm_gateway/node_gateway_client_test.py agent/state_native_parity_test.py; do
  m="$(echo "${f%.py}" | tr '/' '.')"
  n=$((n+1))
