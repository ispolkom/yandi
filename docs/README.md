...
| [ORCHESTRATOR_MEMORY.md](ORCHESTRATOR_MEMORY.md) | The orchestrator with memory and relationships: the verified summary is spoken by the Voice, only the person's words become memory; what is not done yet |
